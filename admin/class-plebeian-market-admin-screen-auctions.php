...
class Plebeian_Market_Admin_Screen_Auctions
{
	...
	static function plebeian_admin_auctions_page_html()
    {
        ...
        wp_enqueue_script('plebeian-market-admin-screen-auctions', pluginBasePath . 'admin/js/plebeian-market-admin-screen-auctions.js', ['jquery', 'plebeian-market-admin', 'plebeian-market-admin-screen-items'], PLEBEIAN_MARKET_VERSION, false);
        ?>
