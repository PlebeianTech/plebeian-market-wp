...
?>
        <div class="row">
            <div class="col-6 information_page">
                ...
                <img src="<?php echo PLEBEIAN_MARKET_PLUGIN_BASEPATH ?>common/img/plebeian_market_logo.png" alt="Plebeian Market, powered by Plebeian Technology">
                ...
                <p>
                    ...
                    but for a specific widget you can override that value and use a 20 pixel title font if that matches the
                    theme of that page better. See how to do that in the next section.
                </p>
                ...
                <p>
                    You can use the
                    <img src="<?php echo PLEBEIAN_MARKET_PLUGIN_BASEPATH ?>admin/img/code-square.svg" class="shortCodeIcon" alt="Copy Shortcode" style="font-size: 2em;">
                ...
                <div class="collapse" id="buyNowSpecificWidgetAdvanced">
                    <div class="card card-body card-100">
                        <p>
