...
class Plebeian_Market_Admin_Screen_Information {
	...
	static function plebeian_admin_information_page_html() {
		...
		<div class="wrap">
			...
			<p>This is the WordPress plugin for integration with <a href="https://plebeian.market/"
				target="_blank">Plebeian Market</a>, powered by <a href="https://plebeian.technology/"
				target="_blank">Plebeian Technology</a>.
			</p>
		</div>
		...
		<p>If you need support, you can find us on <a class="link" href="https://t.me/PlebeianMarket"
		    target="_blank">Telegram</a> or email us at <a class="link" href="email:support@plebeian.market">
			support@plebeian.market</a>. If you have a more technical feedback or would like to contribute to
			the development, you can find us on <a class="link" href="https://github.com/PlebeianTech"
		...
		<hr>
			...
			<h3>Show a specific product</h3>
				...
				<p>
					...
					directly copy the shortcode for a specific item.</p>
				<p></p>
				<p>
		...
		<hr>
			...
			<h3>Show a specific auction</h3>
				...
				<p>You can use the 
					<img src="<?= plugin_dir_url( __FILE__ ) ?>img/code-square.svg" class="shortCodeIcon" alt="Copy Shortcode" style="font-size: 2em;">
					(copy shortcode) icon in <a href="<?= admin_url('admin.php?page=plebeian_market_auctions') ?>">Auctions</a> to directly copy the shortcode for a specific auction.</p>
		<?php
	}
}